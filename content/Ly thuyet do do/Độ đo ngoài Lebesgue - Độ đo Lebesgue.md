...
> Đô đo ngoài Lebesgue trên $\mathbb{R}$, kí hiệu là ${} \mu_{L} ^{*}$ là một hàm tập xác định trên toàn bộ không gian con $\mathcal{B}(\mathbb{R})$, được định nghĩa bởi:
> $$
...
> $$
> , với mọi $E \in \mathcal{B}(\mathbb{R})$. 
...
> Một tập $E \in \mathcal{B}(\mathbb{R})$ được gọi là $\mu_{L} ^{*}$ đo được (hay Lebesgue đo được) nếu với mọi tập thử $A \in \mathcal{B}(\mathbb{R})$, ta có đẳng thức:
> $$
...
> Sự đo được $\mu_{L}^{*}$ - đo được của một tập $E \in \mathcal{B}(\mathbb{R})$, biểu diễn bởi đẳng thức: 
> $$
> \mu_{L}^{*}(A) = \mu_{L} ^{*}(A \cap E) + \mu_{L}^{*}(A \cap E ^{c}) \text{ với mọi }A \in \mathcal{B}(\mathbb{R})
> $$
...
> Trước tiên, ta chứng minh mọi khoảng mở  $E = (a,b)$ đều là tập Lebesgue đo được. Theo mệnh đề **Theorem 1.** (Tiêu chuẩn *Caratheodory* cho họ tập cơ sở), thay vì xét một tập $A \in \mathcal{B}(\mathbb{R})$, ta chỉ cần chứng minh điều kiện đo được thỏa mãn với khoảng mở $I \in \mathfrak{J_{o}}$:
> $$
